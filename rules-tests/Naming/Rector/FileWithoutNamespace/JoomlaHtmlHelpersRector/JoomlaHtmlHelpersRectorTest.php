...
namespace Rector\Tests\Naming\Rector\FileWithoutNamespace\JoomlaHtmlHelpersRector;
 ...
 * @since  1.0.0
 */
final class JoomlaHtmlHelpersRectorTest extends AbstractRectorTestCase
{
	private const RENAME_MAP = [
		'admin/helpers/html/example.php'      => 'admin/src/Service/Html/Example.php',
	];
	...
	{
		return [
			[new SmartFileInfo(__DIR__ . '/Fixture/admin/helpers/html/example.php.inc')],
		];
	}
