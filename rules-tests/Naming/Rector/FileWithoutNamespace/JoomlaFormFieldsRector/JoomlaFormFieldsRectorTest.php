...
namespace Rector\Tests\Naming\Rector\FileWithoutNamespace\JoomlaFormFieldsRector;
...
/**
 * Unit Tests for the JoomlaHtmlHelpersRector rule.
 *
 * @since  1.0.0
 */
final class JoomlaFormFieldsRectorTest extends AbstractRectorTestCase
{
	private const RENAME_MAP = [
		'admin/models/fields/example.php'       => 'admin/src/Field/ExampleField.php',
		'admin/models/fields/modal/example.php' => 'admin/src/Field/Modal/ExampleField.php',
		'site/models/fields/example.php'        => 'site/src/Field/ExampleField.php',
		'site/models/fields/modal/example.php'  => 'site/src/Field/Modal/ExampleField.php',
	];
	...
	{
		return [
			[new SmartFileInfo(__DIR__ . '/Fixture/admin/models/fields/modal/example.php.inc')],
		];
	}
